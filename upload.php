...
***********************************************************/
	...
	//Get File Ext
		...
		$type = $ImageType[0]; //file type
	//Set Upload directory
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/legdate/assets/images/profile_pics';
	//Set File name
...
<div class="main_column column">
	...
	<div id="formExample">
	    ...
	    <form action="upload.php" method="post"  enctype="multipart/form-data">
	        ...
	        <input type="submit"  class="success " value="Submit" style="width:85px; height:25px; border:none; border-radius:5px; color:#fff;" />
	    </form><br /><br />
	    ...
	    <div id="CroppingContainer" style="width:800px; max-height:600px; background-color:#FFF; margin-left: -200px; position:relative; overflow:hidden; border:2px #666 solid; z-index:2001; padding-bottom:0px;">
	        ...
	        <div id="CropImageForm" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >
	            <form action="upload.php" method="post" onsubmit="return checkCoords();">
	                ...
	                <input type="submit"  class="success" value="Save" style="width:100px; height:30px; border:none;"   />
	            </form>
	        </div>
