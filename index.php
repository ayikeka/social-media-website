 ...
 ?>
	 		<div class="user_details column">
	 			<a href="<?php echo $userLoggedIn; ?>"><img src="<?php echo $user['profile_pic']; ?> "></a>
		 			...
		 			<a href="<?php echo $userLoggedIn; ?>" class='fNlname'><?php
	 		...
	 		<div class="main_column column" >
	 			...
	 			<form class="post_form" action="index.php" method="POST" enctype="multipart/form-data">
	 				...
	 				<button  type="submit" name="post" id="post_button" title="post" ><i class="material-icons" style="color: #e67e20;">send</i></button><br>
	 		...
	 		<div class="trending_div column">
	 			<h4>Trending</h4>
	 			<div class="trends">
	 				<?php
	 					$query = mysqli_query($con, "SELECT * FROM trends ORDER BY hits DESC LIMIT 8");

	 					//We could have also used the while loop for calling the array
	 					foreach ($query as $row) {

	 						$word = $row['title'];
	 						$words_dot = strlen($word) >= 14 ? "..." : "";

	 						$trimmed_word = str_split($word, 14);
	 						$trimmed_word = $trimmed_word[0];

	 						echo "<div style='padding:1px'>";
	 						echo $trimmed_word . $words_dot;
	 						echo "<br></div>";
 	 					}
