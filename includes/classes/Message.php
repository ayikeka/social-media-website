...
class Message{
	...
	public function getMessages($otherUser){
		$userLoggedIn = $this->user_obj->getUsername();
		$user_found_obj = new User($this->con, $userLoggedIn);
		$user_found_obj2 = new User($this->con, $otherUser);
		$data = "";
		...
		while($row = mysqli_fetch_array($get_messages_query)){
			...
			$div_top = ($user_to == $userLoggedIn) ? "<div class='darkProfilePic'><img src='".$user_found_obj2->getProfilePic()."'>
													</div>"."<div class='message' id='dark'>" :
													"<div class='darkerProfilePic'><img src='".$user_found_obj->getProfilePic()."'>
													</div>" . "<div class='message' id='darker'>";
	...
	public function getConvosDropdown($data, $limit){
		...
		if($count > $limit)
			...
			$return_string .= "<input type='hidden' class='noMoreDropdownData' value='true'><p style='text-align:center; margin: 0;'>No Messages to load!</p>";
